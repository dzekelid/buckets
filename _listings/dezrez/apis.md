...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/buckets/master/_listings/dezrez/apis.md
...
- name: Dezrez.Rezi.Client.Api - Cancel a single or multiple tasks from a to-do bucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/buckets/master/_listings/dezrez/apitodocanceltasks-put-openapi.md
- name: Dezrez.Rezi.Client.Api - Cancel a single or multiple tasks from a to-do bucket
  x-api-slug: apitodocanceltasks-put
  description: Cancel a single or multiple tasks from a to-do bucket.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28888-www-dezrez-com.jpg
